...
class Music(commands.Cog):
    ...
    async def node_connect(self):
        ...
        await wavelink.NodePool.create_node(bot=self.bot, host='node2.gglvxd.tk', port=443, password='free', https=True, spotify_client=spotify.SpotifyClient(client_id=ID, client_secret=KEY))
